...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            $table->string('avatar_emoji', 10)->default('🧠')->after('email');
            $table->string('avatar_color', 7)->default('#6366f1')->after('avatar_emoji');
            $table->integer('total_score')->default(0)->after('avatar_color');
    ...
    public function down(): void
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropColumn([
                'avatar_emoji','avatar_color','total_score',
